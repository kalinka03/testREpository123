...
<form action="/guestbook" method="post"  class="form-horizontal">
  ...
  <div class="form-group">
      ...
      <input name="name" type="text" class="form-control" id="lastName" placeholder="Ваше имя">
    </div>
  </div>
   <div class="form-group">
  <div class="col-xs-9 col-xs-12 weigth-tab">
      <input name="email" type="email" class="form-control" id="inputEmail" placeholder=" Ваш Email">
    </div>
  </div>
...
<!-- 
<form name="test" action="/guestbook" method="post">
